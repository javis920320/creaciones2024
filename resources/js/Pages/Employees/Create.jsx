...
>
  /Listar
            ...
            <div className="w-full flex justify-center gap-4">
                ...
                <h2 className="text-gray-700 dark:text-gray-400 mb-4">Completa la informacion necesaria para registrar un empleado</h2>
                <h2 className="text-gray-700 dark:text-gray-400 mb-4">(*) Informacion Obligatoria</h2>
                    <form className="flex flex-col" onSubmit={handleSubmit}>
                        <div className="flex gap-3">
                            ...
                            <div className="mt-4">
                                ...
                                value={data.nombreCompleto}
                                    ...
                                    placeholder=""
                                ></TextInput>
                                <InputError message={errors.nombreCompleto} className="mt-2" />
                            </div>
                            <div className="mt-4">
                                <InputLabel>
                        ...
                        <div>
                            ...
                            value={data.fechaNacimiento}
                                ...
                                placeholder=""
                            ></TextInput>
                            <InputError message={errors.fechaContratacion} className="mt-2" />
                        </div>
                        ...
                        <SecondaryButton type="submit">{iseditable?"Actualizar Datos": "registrar empleado"}</SecondaryButton>
                    </form>
                </Section>
                {/* <Section>
                    <div>
