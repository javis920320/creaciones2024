                ...
                <Section className="min-w-[400px]">
                    ...
                    <form onSubmit={handleSubmit}>
                        <div>
                            ...
                            <TextInput value={data.nameCategory} onChange={(e)=>setData("nameCategory",e.target.value)}></TextInput>
                            <InputError message={errors.nameCategory}></InputError>
                        </div>
                        <div>
                            <InputLabel>Descripcion</InputLabel>
                            <TextArea onChange={(e)=>setData("descripcion",e.target.value)}></TextArea>
                            <InputError message={errors.descripcion}></InputError>
                        </div>
                        <SecondaryButton type="submit">{iseditable?"Editar Categoria":"Crear Categoria"}</SecondaryButton>
                    </form>
                </Section>
            </div>
        </AuthenticatedLayout>
